                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="formulario__grupo" id="grupo__nombre">
                                            ...
                                            <div class="formulario__grupo-input">
                                                <input type="text" class="input-login" name="txtNombre" id="txtNombre" placeholder="Nombre...">
...
---->  
                                        <div class="formulario__grupo" id="grupo__Descripcion">
                                            ...
                                            <div class="formulario__grupo-input">
                                                <input type="text" class="input-login" name="txtDescripcion" id="txtDescripcion" placeholder="Nombre...">
                                                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                            </div>
                                        ...
                                        <label for="" class="formulario__label">Ingrese Foto</label>
                                        <div class="form-group">                            
                                            <input class="input-login" type="file" name="txtFoto" placeholder="sad">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">  
                                        <!--
                                        ...
                                        <div class="formulario__grupo" id="grupo__Precio">
                                            ...
                                            <div class="formulario__grupo-input">
                                                <input  type="text" class="input-login" name="txtPrecio" id="txtPrecio" placeholder="Precio...">
                                                <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="formulario__grupo" id="grupo__Stock">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="input-login" name="txtStock" id="txtStock" placeholder="Stock...">
                                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                                </div>
                                                <!--    --MENSAJE DE ERROR Precio -->  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="input-login" name="txtcategoria">
